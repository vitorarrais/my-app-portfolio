package com.vitorarrais.spotify_streamer.ui;
    ...
    private int getOrientation(RecyclerView parent) {
        if (parent.getLayoutManager() instanceof LinearLayoutManager) {
            ...
            throw new IllegalStateException(
                    "com.vitorarrais.spotifystreamer.app.activity.ui.DividerItemDecoration can only be used with a LinearLayoutManager.");
        }
    }
}
